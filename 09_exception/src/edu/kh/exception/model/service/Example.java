...
//============================try catch 구문 사용 예시=============================
	...
	public void ex2() {
		...
		try {
			...
			// 문제 발생 시 해결방안, 문제원인 등을 규명 
		}
	}
	
// 7교시	
//================== try / catch / finally / sc.close() 예시 ========================
//============== ArithmeticException / InputMismatchException 예시 ==================
...
//			It is already handled by the catch block for Exception
			...
			// finally : catch 구문 수행 여부에 관계없이 무조건 실행하는 구문
