...
import edu.kh.poly.ex2.model.vo.RSCCalculator;

public class AbtractionService {
...
//===================================================================================
		...
		a1.breath();
		a2.breath();
//		실행전 : void edu.kh.poly.ex2.model.vo.Animal.breath
//		         Animal의 breath()와 연결된 것으로 보임 (정적 바인딩)
//		         실행중 오버라이딩한 자식의 breath()로 연결됨(동적 바인딩)
...
//===================================================================================
		...
		// 모두 강제 오버라이딩한  breath()라는 공통적인 메서드를 가지고 있으므로
		// arr[i].breath(); 작성 가능 
...
//======================================여기부터 3교시====================================
	public void ex2() {
		...
		// KH k1 = new KH();  // Error : Cannot instantiate the type KH
...
//		---------------------------------------
		...
		// 클래스/ 추상클래스를 상속한 자식 객체는 내부에 부모 객체를 포함하고 있으나
...
//======================================여기부터 4교시====================================	
		...
		arr[1] = new HGD(); // 업캐스팅
		// 부모 타입 참조 = 자식 객체;
		// 부모 : KH인터페이스 ==인터페이스 부모 참조 변수로 사용 가능 
		System.out.println("----------------------------------");
		for(int i =0; i<arr.length; i++) {
...
//==============================================	
	public void ex3() {
		...
		Calculator cal = new RSCCalculator();
