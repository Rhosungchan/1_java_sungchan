...
//		System.out.println(c1.toString());
	...
	public void ex2() {
		...
		arr[1] = new Truck(8, 3, "경유", 5.0); // Truck 객체(업스캐팅 적용)
		// Car 타입의 참조 변수

		arr[2] = new Spark(4, 4, "휘발유", 0.5); // Spark 객체
		// Car 타입의 참조 변수
	...
	public void printCar(Car c) {
		...
		// 동적 바인딩을 이용해서 자식의 toString()을 호출
	}

//  아래 2가지 출력 메서드를 업캐스팅과 오버라이딩을 통해 위 하나의 메서드로 축소  
...
//		-----------------------------------------------------------------------
		// * 해결방법 : instanceof 연산자로 다운캐스팅 할 타입이 맞는지 검사한다.
