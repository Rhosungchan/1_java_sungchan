...
// 콘솔에 보여지는 내용을 출력, 입력받는 용도의 클래스 
public class MethodExampleView {                               // {}는 내부는 클래스
	
	// 클래스 내 어디서든 사용 가능한 Scanner 객체 생성
	// 캡슐화 원칙에 따라서 private 사용 
	private Scanner sc = new Scanner(System.in);
	
	private MethodExampleService service = new MethodExampleService();
	
	// void : 반환 값이 없음
	public void displayMenu() {                                // {} 내부는 지역변수 
		...
		do {
			...
			System.out.println("3. 매개변수 x, 리턴 값 0");
			System.out.println("4. 매개변수 0, 리턴 값 0");
			...
			case 2 : // service.method2(100,50,30); 
				     // this.menu2();
					    menu2();  // 현재 객체가 가지고 있는 menu2()메서드 호출   
					    break;
					    
			case 3 : String result = service.method3();  // method3() 호출 후 String 값을 반환 받고 그 값을 result 변수에 저장
