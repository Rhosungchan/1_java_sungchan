...
//		-> 클래스명.static 필드명/메서드명
		...
		System.out.println(t1.email);   // 초기화되어 있는가? 
		System.out.println(t1.salary);  // 초기화되어 있는가?
		System.out.println(t1.classroom); // 초기화되어 있는가?
		
		Trainee t2 = new Trainee(); // 훈련생 객체 생성 
		
		System.out.println(t2.name);
		System.out.println(t2.phone);
		System.out.println(t2.email);   // 초기화되어 있는가? 
		System.out.println(t2.salary);  // 초기화되어 있는가?
		System.out.println(t2.classroom); // 초기화되어 있는가?
