...
public class WhileExample {
	 ...
	 *  - 반복 횟수가 정해져 있지 않지만 언젠간 반복이 종료되는 경우에 사용  
	 * 
	 *  [작성법]   
	 *  while(조건식) {
	...
	int input=-1;
	  ...
	  // 하지만 input 변수 선언시 초기화되어 있지 않으면 
	  // 조건식 수행을 못하기 때문에
	  // 0이 아닌 임의의 값을 이용해서 초기화함.
	  
	  // ->0은 왜 안되는가?
	  // 0으로 초기화 하는경우 while문 조건이 바로 false가 되어 
	...
	while(input !=0) {
		...
		// ==input변수가 해석되지 않는다== 변수가 존재하지 않는다.
